...
@
This behavior is desirable if you need to be strict about how data is offered
...
dmy("01 01 69")
@
This behavior is according to the 2008 POSIX standard, but one should expect that this
...
\code{amatch}, which mimics the behavior of \R{}'s \code{match} function:
