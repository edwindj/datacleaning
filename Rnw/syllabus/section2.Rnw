...
% -[v]  regels overslaan, gebruiken van readLines
% -[v]  regels overslaan, gebruiken van scan
% -[v]  Special values, and how are they stored (NA, NULL,...)
% -[v]  labels van categoriale variabelen
