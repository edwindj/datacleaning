...
or have extraordinary values such as infinity or missing that obstruct s
tatistical analysis.
...
In many cases an invalid or imcomplete observation can be corrected and imputed,
...
influence the statistical analysis (in a positive sense).
